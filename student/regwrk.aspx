        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList1" runat="server">
                    ...
                    <asp:ListItem>BHUTTA COLLEGE OF ENGINEERING</asp:ListItem>
                    ...
                    <asp:ListItem>DOON VALLEY SIRSA </asp:ListItem><asp:ListItem></asp:ListItem>
                <asp:ListItem>JIMS NEW DELHI </asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
